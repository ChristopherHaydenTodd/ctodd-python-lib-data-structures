...
def main():
    ...
    setup(
        ...
        description=("Python utilities used for interacting with Python Data Structures"),
        ...
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-data-structures",
        version=version,
    )
